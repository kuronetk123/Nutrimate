  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <textarea className="w-full p-4 border border-gray-300 rounded-lg mt-4" placeholder="Enter your ingredients or dietary preferences..."></textarea>
        <button
          onClick={generateMealPlan}
          disabled={loading}
          className="font-medium items-center mt-12 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 hover:from-pink-500 hover:to-yellow-500 text-white py-2 px-4 rounded-lg shadow-xl hover:bg-cyan-700 transition disabled:opacity-50 flex cursor-pointer"
        >

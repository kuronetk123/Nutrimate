                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {favorites.map((recipe) => (
                                <motion.div
                                    ...
                                    animate="visible"
                                >
                                    <Link href={`/cong-thuc/${recipe._id}`}>
                                        <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    <h3 className="font-semibold">{recipe.name || recipe.title}</h3>
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">{recipe.calories || recipe?.nutrition?.calories} kcal</p>
                                                </div>
